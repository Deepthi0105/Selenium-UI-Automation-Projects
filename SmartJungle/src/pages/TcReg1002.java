...
public class TcReg1002 {
	WebDriver driver;

	public TcReg1002(WebDriver driver) {
		this.driver = driver;
	}
	...
	String urlAfterContinue = "https://www.smartjungle.co.uk/index.php?route=account/register";
	...
	public void enterFirstName() throws IOException {
		firstName.sendKeys(ExcelDataOperations.readExcel(0, 1, "RegisterPage1"));
	}

	public void enterLastName() throws IOException {
		lastName.sendKeys(ExcelDataOperations.readExcel(1, 1, "RegisterPage1"));
	}

	public void enterEmailId() throws IOException {
		emailId.sendKeys(ExcelDataOperations.readExcel(2, 1, "RegisterPage1"));
	}

	public void enterTelephoneNo() throws IOException {
		telephone.sendKeys(ExcelDataOperations.readExcel(3, 1, "RegisterPage1"));
	}

	public void enterfax() throws IOException {
		fax.sendKeys(ExcelDataOperations.readExcel(4, 1, "RegisterPage1"));
	}

	public void enterCompanyName() throws IOException {
		companyName.sendKeys(ExcelDataOperations.readExcel(5, 1, "RegisterPage1"));
	}

	public void enterAddressOne() throws IOException {
		addressOne.sendKeys(ExcelDataOperations.readExcel(6, 1, "RegisterPage1"));
	}

	public void enterAddressTwo() throws IOException {
		addressTwo.sendKeys(ExcelDataOperations.readExcel(7, 1, "RegisterPage1"));
	}

	public void enterCity() throws IOException {
		city.sendKeys(ExcelDataOperations.readExcel(8, 1, "RegisterPage1"));
	}

	public void enterPostalCode() throws IOException {
		postalCode.sendKeys(ExcelDataOperations.readExcel(9, 1, "RegisterPage1"));
	...
	public void enterPassword() throws IOException {
		enterPassword.sendKeys(ExcelDataOperations.readExcel(10, 1, "RegisterPage1"));
	}

	public void enterConfirmPassword() throws IOException {
		enterConfirmPassword.sendKeys(ExcelDataOperations.readExcel(11, 1, "RegisterPage1"));
	}

	public void onClickSubscribe() throws InterruptedException {
